...
function Footer() {
    return (
        <div>
            <footer>
                <div className="footer-part bg-slate-50 mt-32 h-full p-14">
                        ...
                        <div className="grid grid-cols-5 gap-2 flex-wrap mt-5">
                            <div className="flex">
                                <div className="footer-logo">
                                    ...
                                    <div className='footer-contect mt-10 text-start text-gray-500'>
                                        <p>
                            ...
                            <div className='col-lg-2 flex'>
                                <div className='footer-text footer-col ml-14'>
                                    <h4 className='footer-title absolute font-semibold underline underline-offset-1 mr-6'>Information</h4>
                                ...
                                <div className='footer-text4'>
                                    ...
                                    <div className='form mt-5'>
                                        <form action="#">
                                            ...
                                            <button className='sub-now bg-rose-600 inline-block font-medium px-7 py-4 mt-5 mr-20 rounded-md text-white'>
                                                Subscribe Now
                    ...
                    <div className='mx-auto footer-end flex justify-between my-6 p-6 bg-stone-200'>
