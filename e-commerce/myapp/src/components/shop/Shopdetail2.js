    ...
    return (
        <div>
            ...
            <div className='flex justify-around mt-16'>
                <img src={product1} alt="" className='h-[40rem] rounded-md' />
                <div className='text-start w-1/3'>
                    ...
                    <h1 className='text-2xl font-bold mt-2'>Bradley Burgess 2<span className='border py-0.5 ml-3 text-rose-600 font-semibold text-sm px-2 rounded-sm'>In Stock</span></h1>
                    <p className='text-xl font-bold text-gray-500'>$9.35<span className='text-rose-600 text-4xl font-bold ml-2'>$20</span></p>
