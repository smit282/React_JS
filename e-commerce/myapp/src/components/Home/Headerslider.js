...
import bannerslider1 from '../assets/banner-slider-01.jpg'
import bannerslider2 from '../assets/banner-slider-02.jpg'
      ...
      <div className='grid grid-cols-12'>
        <div className='p-5 col-start-3 col-span-7'>
          <Swiper spaceBetween={30} centeredSlides={true} autoplay={{delay: 2500, disableOnInteraction: false,}} navigation={false} modules={[Autoplay, Pagination, Navigation]} className="h-[470px] w-full">
            <SwiperSlide>
              <img className='rounded-md absolute' src={banner1} alt=""/>
              <div className='top-28 pl-16 text-left absolute'>
                ...
                <div className='mt-5'>
                  <Link to='/shop' className="slider-btn rounded-md px-8 py-4 font-bold text-xs bg-white">Shop Now <a className='ml-3'><i class="fa-solid fa-arrow-right-long"></i></a></Link>
                </div>
              </div>
            </SwiperSlide>
            <SwiperSlide>
              <img className='rounded-md absolute' src={banner2} alt=""/>
              <div className='top-28 pl-16 text-left absolute'>
                <h2 className='text-red-500 text-lg'>
                  Accessories
                </h2>
            ...
            <SwiperSlide>
              <img className='rounded-md absolute' src={banner3} alt=""/>
              <div className='top-28 pl-16 text-left absolute'>
                <h2 className='text-red-500 text-lg'>
                  Accessories
                </h2>
        ...
        <div className='col-start-10 col-span-12'>
          <img className='my-5 rounded-lg' src={bannerslider1} alt="" />
          ...
          <img className='rounded-lg' src={bannerslider2} alt="" />
